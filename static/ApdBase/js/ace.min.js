...
function handle_side_menu() {
	...
	$("#sidebar-collapse").on("click", function() {
		...
		itag = $("#sidebar-collapse i");
		if(itag.hasClass("icon-double-angle-left")){
			itag.removeClass("icon-double-angle-left").addClass("icon-double-angle-right");
		}
		else {
			itag.removeClass("icon-double-angle-right").addClass("icon-double-angle-left");
		}
	...
	$(".nav-list li.leaf").on("click",function(){
		$(".nav-list li.leaf").removeClass("active");
		var li = $(this).addClass("active");
		var li2 = li.siblings(".branch").removeClass("open active").children().eq(1).slideUp(200);
	});
	$(".nav-list .dropdown-toggle").each(function() {
		...
		$(this).on("click", function() {
			...
			$(b).slideToggle(200).parent().toggleClass("open").siblings().removeClass("active").end().toggleClass("active");
			return false
		})
	})
}
function hover_side_menu(id){
	$(".nav-list li.leaf").removeClass("active");
	var a = $("#"+id).addClass("active");
	a.parents(".branch").addClass("open active");
	a.parents(".submenu").slideDown(200);
}
